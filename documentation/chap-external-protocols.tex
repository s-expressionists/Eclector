...
Clients using this package pass an instance for which methods on the
generic functions described below are applicable to \texttt{read}.
Suitable client classes can be constructed by using

...
\title{{\Huge \sysname{}}\\
A portable Common Lisp reader}

\author{Robert Strandh \and Jan Moringen}
...
\inputtex{chap-recovering-from-errors.tex}
\inputtex{chap-side-effects.tex}
